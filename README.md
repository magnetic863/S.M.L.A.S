...
* **Фокусировка Т-сталью:** Каждый столбик изолирован трансформаторной сталью 3408 по бокам. Она экранирует боковое рассеивание и направляет энергию вертикально, создавая эффект «магнитного луча».
* **Монолитизация:** Матрица зафиксирована в диэлектрическом основании (полимер/эпоксидная смола).

![Схема ячейки статора](1770334812328.png)
