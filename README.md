...
Цель проекта: Этот репозиторий — стресс-тест моей логики и инженерная разминка. Если проект выдержит профессиональную критику, следующий проект ответит на вопрос: можно ли создать магнитный двигатель, использующий магнитное поле в качестве топлива?
